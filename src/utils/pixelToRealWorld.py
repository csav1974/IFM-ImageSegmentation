"""
    This script is spezific for the IFM used at the Univerisity of Innsbruck.
    Change the xml handling to your needs or set a fixxed parameter for the conversion in the funktions at the top.
"""
...
def calculate_pixels_per_mm(xml_file: str) -> float:
    ...
    if pixel_vector is None:
        raise ValueError("Could not find the <pixelsize>/<vector> element in the XML file.")
